                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="buying-price" value="<?php echo remove_junk($product['buy_price']);?>" min="0">
                  ...
                  <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <div class="input-group">
                       ...
                       <input type="number" class="form-control" name="saleing-price" value="<?php echo remove_junk($product['sale_price']);?>" min="0">
                       <span class="input-group-addon">.00</span>
                    </div>
                   </div>
                  </div>
...
<script>
    ...
    var existingQuantityInput = document.getElementById('existingQuantity');
    var newQuantityInput = document.getElementById('new-product-quantity');
    var totalQuantityInput = document.getElementById('total-quantity');

    function calcularCantidadTotal() {
        var existingQuantity = parseFloat(existingQuantityInput.value) || 0;
        var newQuantity = parseFloat(newQuantityInput.value) || 0;
